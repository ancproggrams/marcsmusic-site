...
function setupBooking() {
  ...
  async function submitBooking() {
    ...
    if (!submitBooking.request || submitBooking.request.payload !== serializedPayload) {
      submitBooking.request = { payload: serializedPayload, key: crypto.randomUUID() };
    }
    ...
    try {
      const response = await fetch("/api/booking/create", {
        ...
        headers: {
          ...
          "idempotency-key": submitBooking.request.key
        },
