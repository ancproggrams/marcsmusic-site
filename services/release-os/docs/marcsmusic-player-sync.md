...
The existing production player is in `marcsmusic.nl/index.html` as a hardcoded
...
`index.html` player should be done through an explicit deployment workflow so
