...
export const run466SeedPlatforms: PlatformInput[] = [
  {
    name: 'MOCRadio Network Free Indie MP3 Email Airplay Route',
    websiteUrl: 'https://mocradio.com/',
    submissionUrl: 'https://mocradio.com/submit-music/',
    sourceUrl: 'https://mocradio.com/submit-music/',
    sourceType: 'automation_run_466_public_research',
    country:
      'United States (West Palm Beach, Florida) internet-radio network with worldwide online listenership; artist-location eligibility is not explicitly stated',
    language: 'en',
    genres: [
      'independent-music',
      'hip-hop',
    ...
    submissionMethod:
      'official-first-party-public-music-submission-mailbox-for-clean-mp3-radio-airplay-review',
    feeRequired: false,
    feeAmount:
      'The first-party submission page publishes no fee for standard editorial review. Optional promotional packages for guaranteed exposure and live interviews are separate and must not be entered without explicit payment approval.',
    loginRequired: false,
