...
export const run424SeedPlatforms: PlatformInput[] = [
  {
    name: 'KAOS 89.3FM Olympia Freeform Full-Release Digital and Physical Submission Opportunity',
    websiteUrl: 'https://www.kaosradio.org/',
    submissionUrl: 'mailto:kaosmusicdirector@gmail.com',
    sourceUrl: 'https://www.kaosradio.org/submitmusic',
    sourceType: 'automation_run_424_public_research',
    country:
      'United States / Olympia, Washington non-commercial freeform community radio station licensed to The Evergreen State College; Pacific Northwest artists are prioritized but international eligibility is not explicitly published',
    language: 'en',
    genres: [
      'community-radio',
      'college-radio',
      ...
      'full-release-only',
      'no-singles',
      'digital-streaming-and-download-links',
      'no-email-attachments',
      'physical-cd-vinyl-cassette',
      'one-sheet-or-press-release',
      'fcc-clean-no-safe-harbor',
      'no-visible-login-captcha-or-payment',
      'manual-review'
    ],
    submissionMethod:
      'official-first-party-music-department-email-for-streaming-and-download-links-with-optional-physical-full-release-delivery',
    feeRequired: false,
    feeAmount:
      'The official submission guidance publishes direct digital and physical delivery routes and does not state a submission fee or paid prerequisite.',
    loginRequired: false,
