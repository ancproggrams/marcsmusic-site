...
export const run418SeedPlatforms: PlatformInput[] = [
  {
    name: 'Airhug Radio Conditional Global Independent-Music Submission Form Opportunity',
    ...
    sourceType: 'automation_run_418_public_research',
    country:
      'United States / global independent internet radio with country-of-origin intake and conditional rights-registration eligibility',
    language: 'en',
    genres: [
      'internet-radio',
      'independent-artists',
      ...
      'soundexchange-registration-required',
      'explicit-content-disclosure',
      'clean-version-conditional',
      'ai-music-prohibited',
    ...
    submissionMethod:
      'official-first-party-four-step-music-submission-form-with-file-upload-rights-authorization-and-digital-signature',
    feeRequired: false,
    feeAmount:
      'No submission fee or payment step was visible in the reviewed first-party four-step form. A human must recheck the live form before completion and stop if any payment or protected control appears.',
    loginRequired: false,
